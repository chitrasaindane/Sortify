// # Service Worker for PWA (Progressive Web App) Support in React App (Vite) # 

// # IsLocalhost Check (For Development) 
...
function checkValidServiceWorker(swUrl, config) {
    ...
    fetch(swUrl, {
        ...
        .catch(() => {
            console.log(
                'No Internet Connection Found. App Running In Offline Mode.'
            );
        });
}
